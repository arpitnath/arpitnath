...
Before Zoops, I was one of the founding engineers at [ToolJet](https://github.com/ToolJet/ToolJet ), an open-source low-code platform. I joined when the team was small and contributed across the stack — building the core product and architecture, performance optimization (frontend and backend), and platform scaling. I spent 3 years there, taking the product from an early stage to an enterprise scale.
...
I write about systems, performance, and infrastructure on [Medium](https://medium.com/@arpitnath42 ).
